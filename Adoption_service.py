...
def list_projects_in_organization(org_id):
    ...
    request = resourcemanager_v3.SearchProjectsRequest(query=f"parent.type:organization parent.id:{org_id}")
    ...
    try:
        ...
        for org_project_id in projects:
            try:
                ...
                project_data, employee_ids = fetch_instance_data(org_project_id)
